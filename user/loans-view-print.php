...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Print Mkopo
                <a href="loans.php" class="btn btn-danger btn-sm float-end">Back</a>
            </h4>
        </div>
            ...
            <div id="myBillingArea" style="border: 1px solid black; width: 350px; height: fit-content;">
                ...
                ?>
                        <div class="text-center py-5">
                            ...
                            <div>
                                <a href="loans.php" class="btn btn-primary mt-4 w-25">Back</a>
                            </div>
                        </div>
                    <?php
                    }

                    // $orderQuery = "SELECT o.*, c.* FROM loans o, customers c 
                                ...
                                <tbody style="display: flex; flex-direction:column; justify-items:center; align-items: center;">
                                    <tr>
                                        <td style="text-align: center;" colspan="2">
                                            ...
                                            <h4 style="font-size: 20px; line-height: 20px; margin:2px; padding: 0;">Receipt</h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: start;" colspan="2">
                                            ...
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Phone:</strong>                0788928335</pre>
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Date:</strong>                 <?= date('d M Y', strtotime($orderDataRow['order_date'])); ?></pre>
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Receipt No:</strong>           <?= $orderDataRow['invoice_no']; ?></pre>
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Paid:</strong>                 <?= $orderDataRow['paid_amount'] ?></pre>
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Due:</strong>                  <?= $orderDataRow['due_amount'] ?></pre>
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Status:</strong>               <?= $orderDataRow['order_status']; ?></pre>
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Customer:</strong>             <?= $orderDataRow['name'] ?></pre>
                                            <pre style="font-size: 14px; line-height: 20px; margin:0px; padding: 0;"><strong>Contact:</strong>              <?= $orderDataRow['phone'] ?></pre>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    // $orderItemQuery = "SELECT oi.quantity as orderItemQuantity, oi.price as orderItemPrice, o.*, oi.*, p.* 
                    //         FROM loans o, loan_items oi, products p 
                    //         WHERE oi.order_id=o.id AND p.id=oi.product_id AND o.tracking_no='$trackingNo' ";
                    ...
                    <div class="text-center py-5">
                        ...
                        <div>
                            <a href="loans.php" class="btn btn-primary mt-4 w-25">Go back to loans</a>
                        </div>
                    </div>
                <?php
                }
