...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Taarifa za Mkopo
                <a href="loans-view-print.php?track=<?= $_GET['track'] ?>" class="btn btn-info mx-2 btn-sm float-end">Print / Download Receipt</a>
                <a href="loans.php" class="btn btn-danger mx-2 btn-sm float-end">Back</a>
            </h4>
        </div>
        <div class="card-body">
            ...
            ?>
                ...
                if ($orders) {
                    ...
                    ?>
                        <div class="card card-body shadow border-1 mb-4">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label class="mb-1">
                                        Deni:
                                        <span class="fw-bold"><?= number_format($orderData['due_amount'], 2); ?></span>
                                    </label>
                                    <br />
                                    <label class="mb-1">
                                        Anapokwenda:
                        ...
                        $orderItemQuery = "SELECT oi.quantity as orderItemQuantity, oi.price as orderItemPrice, o.*, oi.*, p.* 
                                    FROM loans as o, loan_items as oi, products as p
                ...
                <div class="text-center py-5">
                    <h5>No Tracking Number Found</h5>
                    <div>
                        <a href="loans.php" class="btn btn-primary mt-4 w-25">Go back to orders</a>
                    </div>
                </div>
            <?php
            }
