        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="text-center">
                    <a href="preorders.php" class="btn btn-secondary">Close</a>
                </div>
        ...
        <div class="col-md-12">
            <div class="card mt-4">
                <div class="card-header">
                    <h5 class="mb-0">Taarifa za Oda
                        <a href="preorder-create.php" class="btn btn-danger float-end">Back</a>
                    </h5>
                </div>
                <div class="card-body">
                                    ...
                                    <table style="width:100%; margin-bottom: 20px;" class="align-items-center justify-content-center">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="end">
                                                    <h5 style="font-size: 20px; line-height: 30px; margin:0px; padding: 0;">Oda</h5>
                            ...
                            <div class="table-responsive mb-3">
                                <table style="width:100%;" cellpadding="5">
                                    ...
                                    <tbody>
                                        ...
                                        <!-- <tr>
                                            <td colspan="4" align="start" style="font-weight: bold;">Order Type (Aina ya Agizo): </td>
                                            <td colspan="4"><?= $_SESSION['payment_mode']; ?></td>
                                        </tr> -->
                                        <tr>
                    ...
                    <?php if (isset($_SESSION['productItems'])) : ?>
                        <div class="mt-4 text-end">
                            <button type="button" class="btn btn-primary px-4 mx-1" id="savePreorder">Save</button>
                            <a href="preorder-create.php" class="btn btn-warning px-4 mx-1">Cancel</a>
                        </div>
                    <?php endif; ?>
