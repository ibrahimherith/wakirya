    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary saveCustomerLoan">Save</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="loans-code.php" method="POST">
                ...
                <div class="mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <br />
                            <button type="button" class="btn btn-success w-100 proceedToPlaceLoan">Weka mkopo</button>
                        </div>
                    </div>
                </div>
            <?php
