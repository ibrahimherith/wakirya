...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Taarifa za Oda
                <a href="preorders-view-print.php?track=<?= $_GET['track'] ?>" class="btn btn-info mx-2 btn-sm float-end">Print / Download Receipt</a>
                <a href="preorders.php" class="btn btn-danger mx-2 btn-sm float-end">Back</a>
            </h4>
        </div>
        <div class="card-body">
            ...
            ?>
                    <div class="text-center py-5">
                        ...
                        <div>
                            <a href="preorders.php" class="btn btn-primary mt-4 w-25">Back</a>
                        </div>
                    </div>
                    <?php
                    return false;
                ...
                if ($orders) {
                    ...
                    ?>
                        ...
                        $orderItemQuery = "SELECT oi.quantity as orderItemQuantity, oi.price as orderItemPrice, o.*, oi.*, p.* 
                                    FROM preorders as o, preorder_items as oi, products as p
