...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Rekebisha Taarifa za Mfanyakazi
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="role" required class="form-select">
                                    <option value="user" <?= ($adminData['data']['role'] == 'user') ? 'selected' : ''; ?>>User</option>
                                    <option value="admin" <?= ($adminData['data']['role'] == 'admin') ? 'selected' : ''; ?>>Admin</option>
                                </select>
                            </div>
                            <div class="col-md-3 mb-3">
                                <label for="">Fungia Akaunti</label>
                                <br />
