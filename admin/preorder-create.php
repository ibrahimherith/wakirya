    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary saveCustomerPreorder">Save</button>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="preorders-code.php" method="POST">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="preorder-item-delete.php?index=<?= $key; ?>" class="btn btn-danger">
                                            Ondoa
                                        </a>
                                    </td>
                                </tr>
                ...
                <div class="mt-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <br />
                            <button type="button" class="btn btn-success w-100 proceedToPlacePreorder">Weka Oda</button>
                        </div>
                    </div>
                </div>
            <?php
