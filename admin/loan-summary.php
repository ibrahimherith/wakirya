...
if (!isset($_SESSION['productItems'])) {
    echo '<script> window.location.href = "loan-create.php"; </script>';
}
?>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="text-center">
                    <a href="loans.php" class="btn btn-secondary">Close</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card mt-4">
                <div class="card-header">
                    <h5 class="mb-0">Taarifa za Mkopo
                        <a href="loan-create.php" class="btn btn-danger float-end">Rudi Nyuma</a>
                    </h5>
                </div>
                <div class="card-body">
                                    ...
                                    <table style="width:100%; margin-bottom: 20px;" class="align-items-center justify-content-center">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="end">
                                                    <h5 style="font-size: 20px; line-height: 30px; margin:0px; padding: 0;">Mkopo</h5>
                    ...
                    <?php if (isset($_SESSION['productItems'])) : ?>
                        <div class="mt-4 text-end">
                            <button type="button" class="btn btn-primary px-4 mx-1" id="saveLoan">Save</button>
                            <a href="loan-create.php" class="btn btn-warning px-4 mx-1">Cancel</a>
                        </div>
                    <?php endif; ?>
