...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="preorder-update-code.php" method="POST" class="mt-3">

                <?php
                if (isset($_GET['track'])) {
                    $tracking_no = $_GET['track'];

                    $orderQuery = mysqli_query($conn, "SELECT * FROM preorders WHERE tracking_no='$tracking_no'");
