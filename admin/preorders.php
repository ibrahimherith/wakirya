...
<div class="container-fluid px-4">
    <div class="card mt-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <?php
            // Pagination logic
            $limit = 10; // Set the number of preorders per page
            $page = isset($_GET['page']) ? $_GET['page'] : 1;
            $start = ($page - 1) * $limit;

            // Count total preorders
            $countQuery = "SELECT COUNT(*) as total FROM preorders";
            $countResult = mysqli_query($conn, $countQuery);
            $preorderCount = mysqli_fetch_assoc($countResult)['total'];
            $totalPages = ceil($preorderCount / $limit);
